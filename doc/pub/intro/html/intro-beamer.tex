...
\title{Introduction and motivation}
...
\begin{block}{Stability of matter }
...
\begin{block}{Do we understand the physics of dripline systems? }
...
\begin{frame}[plain,fragile]
\frametitle{Separation energies for oxygen isotopes}
...
\begin{frame}[plain,fragile]
\frametitle{Energy gaps for oxygen isotopes}
...
\begin{frame}[plain,fragile]
\frametitle{Features to be noted}
...
\begin{frame}[plain,fragile]
\frametitle{A modified Hamiltonian}
...
\begin{frame}[plain,fragile]
\frametitle{Numerical solution of the single-particle Schroedinger equation}
...
\begin{frame}[plain,fragile]
\frametitle{Program to solve Schroedinger's equation}
...
\begin{block}{Operators and Slater determinants }
...
\begin{block}{First simple shell-model calculation }
...
\begin{figure}[t]
  \centerline{\includegraphics[width=0.6\linewidth]{figslides/simplemodel.png}}
  \caption{
